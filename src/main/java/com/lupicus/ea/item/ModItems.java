...
public class ModItems
{
    ...
    public static final Item EA_NETHERITE_SWORD = new EASwordItem(ItemTier.NETHERITE, 3, -2.4F, (new Item.Properties()).group(ItemGroup.COMBAT).isImmuneToFire(),"ea_netherite_sword");
